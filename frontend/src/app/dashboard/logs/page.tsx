    ...
    <div className="space-y-10 pb-24 max-w-[1400px] mx-auto">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 border-b border-zinc-100 pb-12">
        <div>
          ...
          <h1 className="text-5xl font-bold uppercase tracking-tight text-zinc-900 leading-none">Audit Trail</h1>
      ...
      <div className="bg-zinc-950 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden group">
        ...
        <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-8 relative z-10">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-white">Security Event Stream</p>
        ...
        <div className="space-y-4 font-mono text-[11px] relative z-10">
          {loading && logs.length === 0 ? (
            <div className="flex items-center gap-4 py-20 justify-center flex-col opacity-40">
               ...
               <p className="uppercase tracking-[0.4em] text-zinc-400 text-[10px] font-bold">Decrypting audit node data...</p>
            </div>
          ) : logs.length === 0 ? (
              ...
              {logs.map((log: any, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    <span className={`px-3 py-1 rounded-lg text-[9px] font-bold uppercase border whitespace-nowrap ${getActionColor(log.action)}`}>
                      {log.action}
                    </span>
                    <span className="text-zinc-400 uppercase font-bold tracking-widest text-[9px] min-w-[80px]">[{log.entity}]</span>
