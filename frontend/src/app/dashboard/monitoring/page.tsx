    ...
    <div className="space-y-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        ...
        <div className="flex items-center gap-4">
          <button 
            onClick={fetchStatus}
            className="flex items-center gap-2 px-4 py-2.5 bg-muted border border-border rounded-xl text-[10px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-all"
          >
