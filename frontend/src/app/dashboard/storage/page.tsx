    ...
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-md p-12 bg-white rounded-[3.5rem] border border-zinc-100 shadow-2xl text-center space-y-8">
          <div className="w-24 h-24 bg-rose-50 rounded-3xl flex items-center justify-center mx-auto">
            <AlertCircle className="h-10 w-10 text-rose-500 animate-pulse" />
          </div>
          <div className="space-y-4">
            <h1 className="text-4xl font-bold uppercase tracking-tight text-zinc-900 leading-none">Security Alert</h1>
            <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-[0.4em] leading-relaxed">
    ...
    <div className="space-y-12 pb-24 max-w-[1400px] mx-auto">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 border-b border-zinc-100 pb-12">
        <div>
          ...
          <h1 className="text-5xl font-bold uppercase tracking-tight text-zinc-900 leading-none">Storage Vault</h1>
        ...
        <div className="flex items-center gap-6 px-10 py-6 bg-zinc-50 rounded-3xl border border-zinc-100/50 shadow-sm">
           <Activity className="h-6 w-6 text-zinc-400" />
           <div>
              <p className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest">Total Monitored Assets</p>
              <p className="text-xl font-bold text-zinc-950">{files.length}</p>
           </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-4 relative group">
          ...
          <select 
            ...
            className="w-full bg-white border border-zinc-100 rounded-2xl p-6 pl-16 text-[10px] font-bold uppercase tracking-[0.2em] outline-none focus:border-zinc-900 transition-all shadow-xl shadow-black/[0.02] appearance-none cursor-pointer"
          >
      ...
      {loading ? (
        <div className="py-40 flex flex-col items-center justify-center opacity-40">
          ...
          <p className="text-[10px] font-bold uppercase tracking-[0.5em] text-zinc-400">Establishing Vault Linkage...</p>
        </div>
        ...
        <div className="py-40 flex flex-col items-center justify-center bg-white rounded-[3.5rem] border border-dashed border-zinc-200">
          ...
          <p className="text-[11px] font-bold text-zinc-300 uppercase tracking-[0.3em]">No assets detected in this sector</p>
        </div>
      ) : (
              ...
              >
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-8">
                    ...
                    <span className="text-[9px] font-bold uppercase tracking-widest px-4 py-1.5 bg-zinc-950 text-white rounded-full">
                      {file.source}
                    </span>
                  </div>

                  <h3 className="text-xl font-bold uppercase tracking-tight text-zinc-900 mb-4 line-clamp-2 leading-[1.1]">
                    {file.sourceTitle}
                  </h3>
                  ...
                  <div className="space-y-3 mb-10">
                    <div className="flex items-center gap-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
                      ...
                      <span className="text-zinc-300">Owner:</span> <span className="text-zinc-600 font-bold">{file.owner}</span>
                    </div>
                    <div className="flex items-center gap-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
                      <div className="w-1 h-1 bg-zinc-200 rounded-full" />
                      <span className="text-zinc-300">Stored:</span> <span className="text-zinc-600 font-bold">{format(new Date(file.createdAt), "dd MMM yyyy")}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4 mt-auto">
                  <a 
                    ...
                    className="flex-1 flex items-center justify-center gap-4 py-5 bg-zinc-50 text-zinc-900 text-[10px] font-bold uppercase tracking-[0.2em] rounded-2xl hover:bg-zinc-950 hover:text-white transition-all shadow-sm"
                  >
